...
class AdminController extends Controller
{
     ...
     * @Template("../Resources/views/Admin/addShow.html.twig")
     */
    ...
    public function deleteSeasonAction($id)
    {
        ...
        if ($season = $repo->find($id)) {
            foreach ($season->getEpisodes() as $key => $episode) {
                $emE = $this->get('doctrine')->getManager();
                $repoE = $em->getRepository('AppBundle:Episode');
                $emE->remove($episode);
                $emE->flush();
            }
     ...
     * @Template("../Resources/views/Admin/addEpisode.html.twig")
     */
     ...
     * @Template("../Resources/views/Admin/omdb.html.twig")
     */
